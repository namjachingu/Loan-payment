...
Towards the end, the train set id defined and a model with two hidden layers in built. The data is then trained on the model, and a model evaluation in performed. 
...
The following table provides information of the features in the dataset:
